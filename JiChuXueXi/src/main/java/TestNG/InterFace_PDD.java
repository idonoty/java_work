...
public class InterFace_PDD {
    ...
    public static String UserToken="2763e1e2af7fa89dfc5693d87800447f"; //用户id：587
...
//    }  //微信自己接口，code每次都会变
    ...
    public static void addPassenger(){
        result=HttpClientUtils.doPostJson(TestUrl,"/user/passenger/addPassenger.json?",
                "{\"birthday\": \"2005-04-06\",\n" +
                        "  \"code\": \"86\",\n" +
                        "  \"credentials\": [\n" +
                        "    {\n" +
                        ...
                        "  \"userType\": 0\n" +
                        "}",null);
        System.out.println("添加联系人信息："+result);
    }
    ...
    public static void deletePassenger(){
        result=HttpClientUtils.doPost(TestUrl,
                "/user/passenger/deletePassenger.json?",
                "token="+UserToken+"&id=167",
                null);
        System.out.println("删除联系人："+result);
    }
}